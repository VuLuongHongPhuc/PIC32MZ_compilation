...
typedef enum
{
    ...
    /* USER: Define states used by the application state machine. */
...
typedef struct
{
    ...
    /* USER: Define any additional data used by the application. */
...
typedef struct
{
    ...
    uint8_t data[8];
    uint8_t endofframe;
}CAN_USB_DATA_TRANSFER;

#define CAN_TX_FIFO_CHANNEL 0
#define CAN_RX_FIFO_CHANNEL 1
#define CAN_STRUCT_SIZE     16
